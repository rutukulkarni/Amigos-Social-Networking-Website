...
<form method=post action="check_login.jsp" onsubmit="return ad();">
   ...
   String flag1= request.getParameter("flag");
        System.out.println("flag in login1 is :: "+flag1);
...
<center>
	   ...
	   %>
		   ...
		   <font face="Palatino Linotype" size=3em color="#F6B300">PASSWORD HAS BEEN RESET!! </font>
		  <%  
		}
	   else
	   {
	   ...
	   {
	   %>
	   <font face="Palatino Linotype" size=4em color="#F6B300">INVALID USERNAME !! </font>
	   <%
	   }
	   else
	   {
	   %>
	   <font face="Palatino Linotype" size=4em color="#F6B300">INVALID PASSWORD !! </font>
		  <%  
	   }
	   }
	   	%>
