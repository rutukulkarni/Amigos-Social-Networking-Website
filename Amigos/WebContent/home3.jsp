...
//ask arun to check just dis part!!!!!
//and then put same in home2

System.out.println("in home3 :: likes= "+likes);
String sql11="SELECT SUM(LENGTH(dislikes) - LENGTH(REPLACE(dislikes, ',', '')) + 1) FROM wall_posts where w_id="+wall_id+"";
Statement st11=con.createStatement();
ResultSet rs11=st11.executeQuery(sql11);
String counter="";
while(rs11.next())
{
	counter=rs11.getString("SUM(LENGTH(dislikes) - LENGTH(REPLACE(dislikes, ',', '')) + 1)");
}

System.out.println("in home3.jsp  count of dislikes = "+counter);


if(Integer.parseInt(counter)==1)
{
	System.out.println("dislikes are null");
%>
<center>
<font color="#3D2729" face="Palatino Linotype" size="3em">
No Dislikes!!</font>
...
{
	System.out.println("dislikes are not null");
%>
<font color="#3D2729" face="Palatino Linotype" size="3em">
This Post is disliked by ::</font>
<%
...
System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!for wallpost id :: "+wall_id+ "dis person disliked it :: "+w);
