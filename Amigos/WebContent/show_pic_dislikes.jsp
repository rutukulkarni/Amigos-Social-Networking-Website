...
<div id="menu" >
	<div id="menu-wrapper">
		<ul>	
			<li class="logo">
			<a href="home.jsp">
			<img src="images/Amigos.png" alt="amigos" height="30" width="50"></a></li>		
...
//path=rs.getString("img_path");
	...
	String sql11="SELECT SUM(LENGTH(dislikes) - LENGTH(REPLACE(dislikes, ',', '')) + 1) FROM image_try where p_id="+p_id888+"";
