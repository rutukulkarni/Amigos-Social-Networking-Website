...
{ 
	String userid=session.getAttribute("uid123").toString();
	System.out.println("userid in passalbumname1="+userid);
	
System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!SESSION OLD WALA!");


String searchUid1 = session.getAttribute("searchUid").toString();
...
System.out.println("searchuid in passalbumname1="+searchUid);
...
ResultSet rs5=st.executeQuery("select * from album where uid="+searchUid+" and album_id='"+albumId+"'");
String sql123="select * from album where uid="+searchUid+" and album_id='"+albumId+"'";
