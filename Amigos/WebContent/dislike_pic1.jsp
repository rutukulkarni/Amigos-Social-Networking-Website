...
System.out.println("in dislike_pic.jsp: Session UID= "+uid);
...
String sql="UPDATE image_try set dislikes=concat(dislikes,',','"+uid+"'   ) WHERE p_id="+i;
...
System.out.println("in dislike_pic sid="+Integer.parseInt(uid));
